        ...
        case 'LIGHTWEIGHT':
          if (Number(weightLimit) < 100 || Number(weightLimit) > 200) {
            return {
              status: 400,
              error:
                'Weight limit for LIGHTWEIGHT drone is between 100 and 200',
            };
          }
          break;
        case 'MIDDLEWEIGHT':
          if (Number(weightLimit) < 200 || Number(weightLimit) > 300) {
            return {
              status: 400,
              error:
                'Weight limit for MIDDLEWEIGHT drone is between 200 and 300',
            };
          }
          break;
        case 'CRUISERWEIGHT':
          if (Number(weightLimit) < 300 || Number(weightLimit) > 400) {
            return {
              status: 400,
              error:
                'Weight limit for CRUISERWEIGHT drone is between 300 and 400',
            };
          }
          break;
        case 'HEAVYWEIGHT':
          if (Number(weightLimit) < 400 || Number(weightLimit) > 500) {
            return {
              status: 400,
              error:
                'Weight limit for HEAVYWEIGHT drone is between 400 and 500',
            };
          }
          break;
        default:
