...
dronesRouter.post(
  ...
  async (req: RegisterDroneReq, res: express.Response) => {
    logger.info('Registering drone', 'Drone Router', 'drone');
    ...
    if (validate.status === 'error') {
      ...
      logger.error(validate.errors.toString(), 'Drone Router', 'drone');
    }
    ...
    if (registerDrone.error) {
      ...
      logger.error(registerDrone.error, 'Drone Router', 'drone');
    }
    res.status(201).json({
      status: 'success',
    ...
    logger.info('Drone registered successfully', 'Drone Router', 'drone');
  },
);
...
dronesRouter.get(
  ...
  async (req: express.Request, res: express.Response) => {
    logger.info('Fetching drone', 'Drone Router', 'drone');
    ...
    if (drone.error || !drone.data) {
      ...
      logger.error(drone.error, 'Drone Router', 'drone');
    }
    res.status(200).json({
      status: 'success',
    ...
    logger.info('Drone fetched successfully', 'Drone Router', 'drone');
  },
);
...
dronesRouter.post(
  ...
  async (req: LoadDroneWithMedicationReq, res: express.Response) => {
    logger.info('Loading drone with medication', 'Drone Router', 'drone');
    ...
    if (loadDroneWithMedication.error) {
      ...
      logger.error(loadDroneWithMedication.error, 'Drone Router', 'drone');
    }
    res.status(201).json({
      status: 'success',
    ...
    logger.info('Drone loaded successfully', 'Drone Router', 'drone');
  },
);
...
dronesRouter.get(
  ...
  async (req: express.Request, res: express.Response) => {
    logger.info('Fetching loaded drones', 'Drone Router', 'drone');
    const droneId = req.params.droneId;
    ...
    if (loadedDrones.error) {
      ...
      logger.error(loadedDrones.error, 'Drone Router', 'drone');
    }
    res.status(200).json({
      status: 'success',
    ...
    logger.info('Loaded drones fetched successfully', 'Drone Router', 'drone');
  },
);
...
dronesRouter.get(
  '/available',
  async (req: express.Request, res: express.Response) => {
    logger.info('Fetching available drones', 'Drone Router', 'drone');
    ...
    if (availableDrones.error) {
      ...
      logger.error(availableDrones.error, 'Drone Router', 'drone');
    }
    res.status(200).json({
      status: 'success',
    ...
    logger.info(
      'Available drones fetched successfully',
      'Drone Router',
      'drone',
    );
  },
...
dronesRouter.get(
  ...
  async (req: express.Request, res: express.Response) => {
    logger.info('Fetching drone battery level', 'Drone Router', 'drone');
    const droneId = req.params.droneId;
    ...
    logger.info(
      'Drone battery level fetched successfully',
      'Drone Router',
      'drone',
    );
  },
  ...
  dronesRouter.put(
    '/:droneId/updateState',
    async (req: express.Request, res: express.Response) => {
      logger.info('Updating drones state', 'Drone Router', 'drone');
      const droneId = req.params.droneId;
      ...
      if (updateState.error) {
        ...
        logger.error(updateState.error, 'Drone Router', 'drone');
      }
      res.status(200).json({
        status: 'success',
      ...
      logger.info('Drones state updated successfully', 'Drone Router', 'drone');
    },
  ),
);
